...
public class Palettization 
{
	...
	public BufferedImage runner(BufferedImage img, BufferedImage cannyImg) throws IOException
	{
		int passes = 15;
		img = getPalette(img, null, passes);
		BufferedImage newImg = new BufferedImage(cannyImg.getWidth(), cannyImg.getHeight(), BufferedImage.TYPE_INT_RGB);		
